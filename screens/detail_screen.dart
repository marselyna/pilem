...
class _DetailScreenState extends State<DetailScreen> {
  ...
  Future<void> _checkIsFavorite() async {
    ...
    setState(() async {
      _isFavorite = await prefs.containsKey('movie_${widget.movie.id}');
    });
  }
  Future<void> _toggleFavorite() async {
    ...
    if (_isFavorite) {
      ...
      prefs.getString('movie_${widget.movie.id}', movie);
      List<String> favoriteMovieIds =
          prefs.getStringList('favoriteMovies') ?? [];
      favoriteMovieIds.add(widget.movie.id.toString());
      prefs.getStringList('favoriteMovies', favoriteMovie);
    } else {
